        ...
        <motion.div style={{ y: textY }}>
          ...
          <Reveal delay={1.9} y={20}>
            <p className="mb-10 max-w-lg text-lg leading-relaxed text-[#c6c5c1]">
              Получите деньги под залог автомобиля со ставкой от 6% в месяц. Автомобиль
              остаётся у вас. Предварительное решение за 10 минут онлайн.
            </p>
          </Reveal>
...
/* ==================================================================== */
const FEATURES = [
  { icon: Banknote, title: "Сумма займа", value: "до 5 млн ₽", desc: "До 500 000 рублей для физических лиц, до 5 000 000 рублей для юридических лиц и ИП" },
...
const FAQ_ITEMS = [
  ...
  {
    q: "Заберёте ли вы мой автомобиль?",
    a: "Нет. Вы продолжаете пользоваться автомобилем как обычно. ПТС остаётся у нас — мы оформляем залог, не изымая транспортное средство.",
  },
  {
